...
src_path1 = u"\\\\Mirek\\___skanowanie\Hrubieszów 3\\"
src_path2 = u"\\\\Opgk455\\__SKANOWANIE\HRUBIESZOW 3\\"
src_path3 = u"\\\\Opgk431\\_SKANOWANIE\HRUBIESZOW_3\\"
src_path4 = u"\\\\Michal-b\\__SKANOWANIE\\HRUBIESZÓW3\\"
src_path5 = u"\\\\_ziomal_\\____skanowanie\HRUBIESZÓW 3\\"
src_path6 = u"\\\\Asus\\SKANOWANIE\\Hrubieszów 3\\"
dst_pathKZ = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Katarzyna Zawada\\"
dst_pathKD = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Krzysztof Doliński\\"
dst_pathMK = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Marcin Kaminski\\"
dst_pathMS = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\MARCIN SIEBIELEC\\"
dst_pathMS2 = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\MIchał Siudym\\"
dst_pathPP = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Piotr Peciak\\"
dst_pathSB = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Sławomir Buchelt\\"
dst_pathLS = u"v:\\3599_ZSIN faza II\\HRUBIESZOWSKI\\0__Badanie_operatow\\0__SKANY\\Lukasz Samolej\\"
...
for (dirpath, dirnames, filenames) in chain.from_iterable(os.walk(dirpath) for dirpath in paths):
    ...
    elif "zgrane" not in katalog and (u"Doliński" or u"doliński" or u"Dolinski" or u"dolinski") in katalog2:  # Doliński
        if modified_date <= wczoraj:
            try:
                os.rename(dirpath, os.path.join(dirpath + "_zgrane"))
                dirpath1 = dirpath + "_zgrane"
...
<<<<<<< HEAD:obsluga_skanowania/przenoszenie_skanow.py
            print ('\x1b[0;30;44m' + dirpath + "   " + 'Do skopiowania w dniu jutrzejszym...' + '\x1b[0m')
    elif "zgrane" in katalog:
        print ('\x1b[0;33;42m' + dirpath + "   " + u"Katalog zostal już przeniesiony..." + '\x1b[0m')
    elif "zgrane" not in katalog and (u"Buchelt" or u"buchelt") in katalog2:  # Buchelt
=======
            print (dirpath + "   " + 'nie kopiuj')
        print('Pomijam')
#TODO: wyrzuca na Buchelt, problem z datą i pobieraniem katalogu
    elif "zgrane" not in katalog and (u"Buchelt" or u"buchelt") in dirpath:                                                 #Buchelt
>>>>>>> master:przenoszenie_skanow.py
        if modified_date <= wczoraj:
            try:
                os.rename(dirpath, os.path.join(dirpath + "_zgrane"))
                dirpath1 = dirpath + "_zgrane"
